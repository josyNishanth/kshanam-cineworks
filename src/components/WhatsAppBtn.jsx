      ...
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {tooltip && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 10 }}
                className="font-sans text-sm font-medium text-white rounded-xl px-4 py-2.5 shadow-xl"
                style={{ background: '#1A1A18', whiteSpace: 'nowrap', pointerEvents: 'none' }}
              >
                Chat with us! 👋
                <div style={{
          ...
          <motion.a
            ...
            style={{ width: 58, height: 58, background: '#25D366', flexShrink: 0 }}
            aria-label="Chat on WhatsApp"
          >
            {/* pulse ring */}
            <motion.span
              className="absolute rounded-full"
              style={{ width: 58, height: 58, background: '#25D366', opacity: 0.35 }}
